...
- [next] Promote the release commit to `main`, then verify the public v1.6.24 DMG, Setup.exe, and SHA256SUMS.txt. Windows Setup compilation remains a required GitHub Actions Windows gate.
