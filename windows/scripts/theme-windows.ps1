...
$script:DreamSkinNexoCatalog = @{
  'stellar-voyager' = @{ Name='星核旅者'; File='01-stellar-voyager.webp'; AccentRGB='112 192 255'; SecondaryRGB='244 190 92'; PanelRGB='14 23 34'; GlowStrength=0.58; Signature='STELLAR VOYAGER'; FocusX=0.68; FocusY=0.46 }
  'sakura-signal' = @{ Name='樱花信使'; File='02-sakura-signal.webp'; AccentRGB='232 151 190'; SecondaryRGB='166 137 232'; PanelRGB='25 20 31'; GlowStrength=0.52; Signature='SAKURA SIGNAL'; FocusX=0.72; FocusY=0.45 }
  'neon-courier' = @{ Name='霓虹信使'; File='03-neon-courier.webp'; AccentRGB='244 93 202'; SecondaryRGB='79 218 229'; PanelRGB='23 15 31'; GlowStrength=0.68; Signature='NEON COURIER'; FocusX=0.66; FocusY=0.48 }
  'mist-beacon' = @{ Name='雾海灯塔'; File='04-mist-beacon.webp'; AccentRGB='230 183 108'; SecondaryRGB='129 164 174'; PanelRGB='23 27 29'; GlowStrength=0.42; Signature='MIST BEACON'; FocusX=0.69; FocusY=0.45 }
  'rain-harbor' = @{ Name='雨港余光'; File='05-rain-harbor.webp'; AccentRGB='86 190 173'; SecondaryRGB='219 157 91'; PanelRGB='13 24 25'; GlowStrength=0.50; Signature='RAIN HARBOR'; FocusX=0.72; FocusY=0.47 }
  'crimson-forge' = @{ Name='绯红铸界'; File='06-crimson-forge.webp'; AccentRGB='232 82 73'; SecondaryRGB='235 170 80'; PanelRGB='30 15 17'; GlowStrength=0.64; Signature='CRIMSON FORGE'; FocusX=0.67; FocusY=0.46 }
  'cloud-antler' = @{ Name='云鹿栖境'; File='07-cloud-antler.webp'; AccentRGB='147 213 181'; SecondaryRGB='190 166 231'; PanelRGB='20 27 25'; GlowStrength=0.44; Signature='CLOUD ANTLER'; FocusX=0.70; FocusY=0.44 }
  'midnight-terminal' = @{ Name='午夜终端'; File='08-midnight-terminal.webp'; AccentRGB='84 205 162'; SecondaryRGB='93 145 218'; PanelRGB='12 21 20'; GlowStrength=0.48; Signature='MIDNIGHT TERMINAL'; FocusX=0.73; FocusY=0.49 }
  'retro-orbit' = @{ Name='复古轨道'; File='09-retro-orbit.webp'; AccentRGB='229 137 72'; SecondaryRGB='83 179 178'; PanelRGB='30 22 17'; GlowStrength=0.55; Signature='RETRO ORBIT'; FocusX=0.69; FocusY=0.45 }
  'strategy-atrium' = @{ Name='策略中庭'; File='10-strategy-atrium.webp'; AccentRGB='205 174 105'; SecondaryRGB='101 164 134'; PanelRGB='28 24 18'; GlowStrength=0.40; Signature='STRATEGY ATRIUM'; FocusX=0.71; FocusY=0.46 }
  'aurora-leviathan' = @{ Name='极光巨鲸'; File='11-aurora-leviathan.webp'; AccentRGB='91 210 207'; SecondaryRGB='155 126 230'; PanelRGB='12 25 30'; GlowStrength=0.62; Signature='AURORA LEVIATHAN'; FocusX=0.68; FocusY=0.42 }
  'ink-ridge-guardian' = @{ Name='墨岭守望'; File='12-ink-ridge-guardian.webp'; AccentRGB='203 166 97'; SecondaryRGB='168 83 76'; PanelRGB='27 23 19'; GlowStrength=0.43; Signature='INK RIDGE GUARDIAN'; FocusX=0.70; FocusY=0.45 }
}
