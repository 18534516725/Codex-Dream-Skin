...
$script:DreamSkinNexoCatalog = @{
  'stellar-voyager' = @{ Name='星核旅者'; File='01-stellar-voyager.webp'; AccentRGB='112 192 255'; SecondaryRGB='244 190 92'; PanelRGB='14 23 34'; GlowStrength=0.58; Signature='STELLAR VOYAGER'; FocusX=0.68; FocusY=0.46; LayoutVariant='poster-right'; SurfaceStyle='glass'; CornerStyle='cut'; MotionPreset='orbit'; SidebarStyle='navigation'; ComposerStyle='console'; TextureStyle='grid' }
  'sakura-signal' = @{ Name='樱花信使'; File='02-sakura-signal.webp'; AccentRGB='232 151 190'; SecondaryRGB='166 137 232'; PanelRGB='25 20 31'; GlowStrength=0.52; Signature='SAKURA SIGNAL'; FocusX=0.72; FocusY=0.45; LayoutVariant='poster-right'; SurfaceStyle='paper'; CornerStyle='stamp'; MotionPreset='petals'; SidebarStyle='garden'; ComposerStyle='letter'; TextureStyle='wash' }
  'neon-courier' = @{ Name='霓虹信使'; File='03-neon-courier.webp'; AccentRGB='244 93 202'; SecondaryRGB='79 218 229'; PanelRGB='23 15 31'; GlowStrength=0.68; Signature='NEON COURIER'; FocusX=0.66; FocusY=0.48; LayoutVariant='poster-right'; SurfaceStyle='metal'; CornerStyle='cut'; MotionPreset='rain'; SidebarStyle='neon'; ComposerStyle='terminal'; TextureStyle='scanline' }
  'mist-beacon' = @{ Name='雾海灯塔'; File='04-mist-beacon.webp'; AccentRGB='230 183 108'; SecondaryRGB='129 164 174'; PanelRGB='23 27 29'; GlowStrength=0.42; Signature='MIST BEACON'; FocusX=0.69; FocusY=0.45; LayoutVariant='editorial'; SurfaceStyle='paper'; CornerStyle='stamp'; MotionPreset='mist'; SidebarStyle='maritime'; ComposerStyle='label'; TextureStyle='grain' }
  'rain-harbor' = @{ Name='雨港余光'; File='05-rain-harbor.webp'; AccentRGB='86 190 173'; SecondaryRGB='219 157 91'; PanelRGB='13 24 25'; GlowStrength=0.50; Signature='RAIN HARBOR'; FocusX=0.72; FocusY=0.47; LayoutVariant='poster-right'; SurfaceStyle='glass'; CornerStyle='cut'; MotionPreset='rain'; SidebarStyle='harbor'; ComposerStyle='console'; TextureStyle='droplets' }
  'crimson-forge' = @{ Name='绯红铸界'; File='06-crimson-forge.webp'; AccentRGB='232 82 73'; SecondaryRGB='235 170 80'; PanelRGB='30 15 17'; GlowStrength=0.64; Signature='CRIMSON FORGE'; FocusX=0.67; FocusY=0.46; LayoutVariant='stage'; SurfaceStyle='metal'; CornerStyle='cut'; MotionPreset='sparks'; SidebarStyle='forge'; ComposerStyle='console'; TextureStyle='grain' }
  'cloud-antler' = @{ Name='云鹿栖境'; File='07-cloud-antler.webp'; AccentRGB='147 213 181'; SecondaryRGB='190 166 231'; PanelRGB='20 27 25'; GlowStrength=0.44; Signature='CLOUD ANTLER'; FocusX=0.70; FocusY=0.44; LayoutVariant='editorial'; SurfaceStyle='ink'; CornerStyle='stamp'; MotionPreset='mist'; SidebarStyle='scroll'; ComposerStyle='label'; TextureStyle='paper' }
  'midnight-terminal' = @{ Name='午夜终端'; File='08-midnight-terminal.webp'; AccentRGB='84 205 162'; SecondaryRGB='93 145 218'; PanelRGB='12 21 20'; GlowStrength=0.48; Signature='MIDNIGHT TERMINAL'; FocusX=0.73; FocusY=0.49; LayoutVariant='console'; SurfaceStyle='metal'; CornerStyle='cut'; MotionPreset='scan'; SidebarStyle='terminal'; ComposerStyle='terminal'; TextureStyle='grid' }
  'retro-orbit' = @{ Name='复古轨道'; File='09-retro-orbit.webp'; AccentRGB='229 137 72'; SecondaryRGB='83 179 178'; PanelRGB='30 22 17'; GlowStrength=0.55; Signature='RETRO ORBIT'; FocusX=0.69; FocusY=0.45; LayoutVariant='pixel-platform'; SurfaceStyle='pixel'; CornerStyle='pixel'; MotionPreset='orbit'; SidebarStyle='station'; ComposerStyle='pixel-console'; TextureStyle='dither' }
  'strategy-atrium' = @{ Name='策略中庭'; File='10-strategy-atrium.webp'; AccentRGB='205 174 105'; SecondaryRGB='101 164 134'; PanelRGB='28 24 18'; GlowStrength=0.40; Signature='STRATEGY ATRIUM'; FocusX=0.71; FocusY=0.46; LayoutVariant='collage'; SurfaceStyle='paper'; CornerStyle='tape'; MotionPreset='none'; SidebarStyle='blueprint'; ComposerStyle='workbench'; TextureStyle='grid' }
  'aurora-leviathan' = @{ Name='极光巨鲸'; File='11-aurora-leviathan.webp'; AccentRGB='91 210 207'; SecondaryRGB='155 126 230'; PanelRGB='12 25 30'; GlowStrength=0.62; Signature='AURORA LEVIATHAN'; FocusX=0.68; FocusY=0.42; LayoutVariant='poster-right'; SurfaceStyle='glass'; CornerStyle='round'; MotionPreset='orbit'; SidebarStyle='aurora'; ComposerStyle='console'; TextureStyle='grain' }
  'ink-ridge-guardian' = @{ Name='墨岭守望'; File='12-ink-ridge-guardian.webp'; AccentRGB='203 166 97'; SecondaryRGB='168 83 76'; PanelRGB='27 23 19'; GlowStrength=0.43; Signature='INK RIDGE GUARDIAN'; FocusX=0.70; FocusY=0.45; LayoutVariant='editorial'; SurfaceStyle='ink'; CornerStyle='stamp'; MotionPreset='ink'; SidebarStyle='scroll'; ComposerStyle='label'; TextureStyle='paper' }
  'post-raccoon' = @{ Name='邮差浣熊'; File='13-post-raccoon.webp'; AccentRGB='218 67 66'; SecondaryRGB='241 190 92'; PanelRGB='18 29 48'; GlowStrength=0.54; Signature='POST RACCOON'; FocusX=0.74; FocusY=0.48; LayoutVariant='poster-right'; SurfaceStyle='paper'; CornerStyle='ticket'; MotionPreset='mail'; SidebarStyle='postal'; ComposerStyle='label'; TextureStyle='halftone' }
  'night-shift-penguin' = @{ Name='夜班企鹅'; File='14-night-shift-penguin.webp'; AccentRGB='224 182 80'; SecondaryRGB='250 225 151'; PanelRGB='17 16 14'; GlowStrength=0.48; Signature='NIGHT SHIFT'; FocusX=0.70; FocusY=0.46; LayoutVariant='stage'; SurfaceStyle='metal'; CornerStyle='round'; MotionPreset='spotlight'; SidebarStyle='setlist'; ComposerStyle='mixer'; TextureStyle='vinyl' }
  'workshop-otter' = @{ Name='工坊水獭'; File='15-workshop-otter.webp'; AccentRGB='43 179 163'; SecondaryRGB='239 132 73'; PanelRGB='24 39 40'; GlowStrength=0.50; Signature='WORKSHOP OTTER'; FocusX=0.72; FocusY=0.47; LayoutVariant='collage'; SurfaceStyle='paper'; CornerStyle='tape'; MotionPreset='doodle'; SidebarStyle='notebook'; ComposerStyle='workbench'; TextureStyle='crayon' }
  'moon-platform-cat' = @{ Name='月台猫站长'; File='16-moon-platform-cat.webp'; AccentRGB='241 170 72'; SecondaryRGB='105 133 211'; PanelRGB='13 18 43'; GlowStrength=0.46; Signature='MOON PLATFORM'; FocusX=0.75; FocusY=0.50; LayoutVariant='pixel-platform'; SurfaceStyle='pixel'; CornerStyle='pixel'; MotionPreset='pixel-rain'; SidebarStyle='station'; ComposerStyle='pixel-console'; TextureStyle='dither' }
  'floppy-wizard' = @{ Name='软盘魔法师'; File='17-floppy-wizard.webp'; AccentRGB='169 105 237'; SecondaryRGB='82 213 224'; PanelRGB='22 15 42'; GlowStrength=0.60; Signature='FLOPPY WIZARD'; FocusX=0.69; FocusY=0.45; LayoutVariant='pixel-desktop'; SurfaceStyle='pixel'; CornerStyle='pixel'; MotionPreset='cursor'; SidebarStyle='file-tree'; ComposerStyle='dialog'; TextureStyle='scanline' }
  'deep-sea-repair' = @{ Name='深海维修队'; File='18-deep-sea-repair.webp'; AccentRGB='54 190 182'; SecondaryRGB='241 112 85'; PanelRGB='10 31 39'; GlowStrength=0.52; Signature='DEEP SEA REPAIR'; FocusX=0.72; FocusY=0.50; LayoutVariant='pixel-console'; SurfaceStyle='pixel'; CornerStyle='pixel'; MotionPreset='sonar'; SidebarStyle='submarine'; ComposerStyle='sonar'; TextureStyle='dither' }
}
...
function Resolve-DreamSkinNexoApplyUri {
  ...
  return [pscustomobject]@{
    Id = $id
    Name = $record.Name
    ImageUri = "$script:DreamSkinNexoAssetOrigin/codex-skins/originals/$($record.File)"
    Appearance = 'dark'
    TaskMode = 'full'
    AccentRGB = $record.AccentRGB
    SecondaryRGB = $record.SecondaryRGB
    PanelRGB = $record.PanelRGB
    GlowStrength = $record.GlowStrength
